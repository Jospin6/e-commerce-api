class RemboursementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @remboursement.save
        format.html { redirect_to remboursement_url(@remboursement), notice: "Remboursement was successfully created." }
  ...
  def update
    respond_to do |format|
      if @remboursement.update(remboursement_params)
        format.html { redirect_to remboursement_url(@remboursement), notice: "Remboursement was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to remboursements_url, notice: "Remboursement was successfully destroyed." }
  ...
  private
    ...
    def remboursement_params
      params.require(:remboursement).permit(:credit_id, :montant_recu, :date_jour)
    end
end
